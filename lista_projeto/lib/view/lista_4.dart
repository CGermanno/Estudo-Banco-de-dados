...
class Tela44View extends StatefulWidget {
  const Tela44View({Key? key}) : super(key: key);

  @override
  State<Tela44View> createState() => _Tela44ViewState();
}

class _Tela44ViewState extends State<Tela44View> {
  List<String> listaDeCompras = [];
  final TextEditingController itemController = TextEditingController();
  String nomeDaLista = 'Lista 04';
    ...
    return Scaffold(
      ...
      body: Container(
        decoration: BoxDecoration(
          color: Colors.blue[100], // Define cor fundo
        ),
        child: Padding(
