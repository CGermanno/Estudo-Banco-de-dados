...
class Tela22View extends StatefulWidget {
  const Tela22View({Key? key}) : super(key: key);

  @override
  State<Tela22View> createState() => _Tela22ViewState();
}

class _Tela22ViewState extends State<Tela22View> {
  List<String> listaDeCompras = [];
  final TextEditingController itemController = TextEditingController();
  String nomeDaLista = 'Lista 02';
    ...
    return Scaffold(
      ...
      body: Container(
        decoration: BoxDecoration(
          color: Colors.green[300], // Define o fundo como Cinza claro
        ),
        child: Padding(
